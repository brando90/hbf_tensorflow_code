...
dump_data_experiment_folder=om_f_4d_conv
#dump_data_experiment_folder=om_f4d
#dump_data_experiment_folder=om_2x2_1_cosx1_plus_x2_depth2
#dump_data_experiment_folder=om_xsinlog1_x_depth2
#dump_data_experiment_folder=om_mnist
...
'task_name': ${task_name},
'dump_data_experiment_folder': ${dump_data_experiment_folder}
'data_normalize': ${data_normalize}
'trainable_S': ${trainable_S}
'mdl': ${mdl}
'train_S_type': ${train_S_type}
'init_type': ${init_type}
'init': ${init}
