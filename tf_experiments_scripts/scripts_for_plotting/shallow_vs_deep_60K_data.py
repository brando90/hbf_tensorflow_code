...
def shallow_vs_deep():
    ...
    path_to_experiments_NN = '../../simulation_results_scripts/%s/task_September_23_NN_xavier_softplus'%experiment_name
    ...
    path_to_experiments_BT = '../../simulation_results_scripts/%s/task_September_23_BTHL_xavier_softplus'%experiment_name
