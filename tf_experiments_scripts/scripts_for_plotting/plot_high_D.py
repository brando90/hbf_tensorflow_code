...
def shallow_vs_deep():
    ...
    nb_params_shallow = 31*np.array([2,3,4])
    ...
    path_to_experiments_BT = '../../simulation_results_scripts/%s/task_Apr_15_BT_32D_Adam_xavier_relu_N60000_original_setup_dgx1'%experiment_name
    ...
    nb_params_bt = 31*np.array([2,3,4])
