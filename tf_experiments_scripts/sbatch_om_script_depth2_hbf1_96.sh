...
python main_nn.py $SLURM_JOBID $SLURM_ARRAY_TASK_ID $folder task_30_july_HBF1_depth_2_1000 HBF1_12_multiple_1000 True 96 multiple_S $task_name False False hbf kern_init $data_normalize $trainable_S
