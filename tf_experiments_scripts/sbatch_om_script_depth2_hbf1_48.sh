...
python main_nn.py $SLURM_JOBID $SLURM_ARRAY_TASK_ID $folder task_1_August_HBF1_depth_2_1000_dont_train_S HBF1_48_multiple_1000 True 48 multiple_S $task_name False False hbf kern_init $data_normalize $trainable_S
