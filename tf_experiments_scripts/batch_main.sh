...
python main_nn.py $SLURM_JOBID $SLURM_ARRAY_TASK_ID $main_folder task_August_10_HBF2_BN HBF_6_6_50_RMSProp True $units multiple_S $task_name True True $mdl $init_type $data_normalize $trainable_S $init $optimization_alg $nb_filters
