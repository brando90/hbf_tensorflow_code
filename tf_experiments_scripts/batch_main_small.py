...
arg.type_job, arg.rand_x = 'slurm_array_parallel', int.from_bytes(os.urandom(4), sys.byteorder)
...
#arg.job_name = 'BT_64D_units5_Adam'
...
arg.job_name = 'NN_64D_units5_Adam'
#
...
arg.low_log_const_learning_rate, arg.high_log_const_learning_rate = -2, -3
...
##
arg.start_stid = 1
if arg.type_job == 'main_large_hp_ckpt':
