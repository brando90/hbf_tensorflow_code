...
def get_arg_for_experiment():
    ...
    arg.get_arg_for_experiment = get_arg_for_experiment
    ##
...
##
arg = get_arg_for_experiment()
arg.get_arg_for_experiment = get_arg_for_experiment
## get parameters to initialize the ckpt run
ckpt_arg = maps.NamedDict()
...
if __name__ == '__main__':
    ...
    if cmd_args.type_job == 'serial':
        ...
        large_main_hp.run_hyperparam_search2(arg,ckpt_arg)
        ...
        large_main_hp.main_large_hp_ckpt(arg,ckpt_arg)
