...
W_filters = tf.get_variable(name='W', dtype=tf.float32, initializer=init_W, regularizer=None, trainable=True)
mdl = mtf.build_binary_tree(xx,filter_size,nb_filters,0,1.0,stride_convd1=2)
...
with tf.Session() as sess:
    ...
    print 'tf mdl conv'
    print sess.run(fetches=mdl, feed_dict={xx:X_train_1d})
